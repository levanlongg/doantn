...
export class ProductTypeComponent implements OnInit {
  ...
  constructor(
    private newstype: ProductTypeService,
  ...
  createEror() {
    this.toastr.error('Chưa thêm loại sản phẩm', 'Thông báo!', { timeOut: 2000 });
  }
  updateSuccess() {
  ...
  deleteEror() {
    this.toastr.error('Chưa xóa loại sản phẩm', 'Thông báo!', { timeOut: 2000 });
  }

  loadData() {
    this.newstype.getListproductype().subscribe((res: any) => {
      this.items = res;
